    ...
    Java.perform(function() {
        ...
        try {
            ...
            UnverifiedCertError.$init.implementation = function (str) {
                console.log('\n\x1b[36m[!] Unexpected SSLPeerUnverifiedException occurred, trying to patch it dynamically...\x1b[0m');
                try {
        ...
        console.log('');
        console.log('======');
        console.log('[#] Root Beer Check Bypass [#]');
        console.log('======');
