The vm check can be bypass with the help of this frida script:
```java
...
This will return always false for the VM check, this will enable us to bypass thge check as follows:
```powershell
...
The full bypass script of the RootCheck and the VMCheck is the following:
```java
