...
public class C10861a {

    /* renamed from: a */
    private static final TimeZone f28065a = TimeZone.getTimeZone("UTC");

    /* renamed from: a */
    private static boolean m6842a(String str, int i, char c) {
        return i < str.length() && str.charAt(i) == c;
    }

    /* renamed from: b */
    private static int m6841b(String str, int i) {
        while (i < str.length()) {
    ...
    */
    public static java.util.Date m6840c(java.lang.String r17, java.text.ParsePosition r18) throws java.text.ParseException {
        /*
            Method dump skipped, instructions count: 553
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: ua.C10861a.m6840c(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    /* renamed from: d */
    private static int m6839d(String str, int i, int i2) throws NumberFormatException {
        int i3;
        int i4;
