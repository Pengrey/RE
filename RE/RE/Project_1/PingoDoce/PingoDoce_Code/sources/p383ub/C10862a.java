...
final class C10862a {
    ...
    public byte[] m6838a() {
        ...
        int m19056i = this.f28067a.m19056i();
        int m19053l = this.f28067a.m19053l();
        for (int i = 0; i < m19056i; i++) {
            int[] iArr = f28066b[i];
            for (int i2 = 0; i2 < m19053l; i2++) {
                int i3 = iArr[i2];
                if (i3 >= 0 && this.f28067a.m19059e(i2, i)) {
                    int i4 = i3 / 6;
