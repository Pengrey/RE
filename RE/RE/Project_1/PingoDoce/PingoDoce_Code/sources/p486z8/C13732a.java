...
public final class C13732a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f34841a;

    /* renamed from: b */
    private static final Map<Integer, String> f34842b;
    ...
    /* renamed from: a */
    public static String m544a(int i) {
        Map<Integer, String> map = f34841a;
        Integer valueOf = Integer.valueOf(i);
        if (map.containsKey(valueOf)) {
            String str = map.get(valueOf);
            String str2 = f34842b.get(valueOf);
