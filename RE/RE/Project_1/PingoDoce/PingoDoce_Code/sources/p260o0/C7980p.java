...
public final class C7980p<K, V> extends AbstractC7979o {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C7980p(C7987t c7987t) {
        super(c7987t);
        Intrinsics.isThisObjectNull(c7987t, "map");
    }

    public /* bridge */ /* synthetic */ boolean add(Object obj) {
        return ((Boolean) m17282h(obj)).booleanValue();
    }

    public /* bridge */ /* synthetic */ boolean addAll(Collection collection) {
        return ((Boolean) m17281l(collection)).booleanValue();
    }

    public boolean contains(Object obj) {
        return m17284b().containsValue(obj);
    }
    ...
    /* renamed from: h */
    public Void m17282h(Object obj) {
        C7989u.m17238b();
        throw new ExceptionsH();
    }

    /* renamed from: l */
    public Void m17281l(Collection collection) {
        Intrinsics.isThisObjectNull(collection, "elements");
        C7989u.m17238b();
        throw new ExceptionsH();
    }
    ...
    /* renamed from: o */
    public SnapshotStateMap iterator() {
        return new SnapshotStateMap(m17284b(), ((InterfaceC5736d) m17284b().m17249k().m17243g().entrySet()).iterator());
    }

    public boolean remove(Object obj) {
        return m17284b().m17246n(obj);
    }
    ...
    public boolean removeAll(Collection collection) {
        ...
        do {
            ...
            for (Map.Entry entry : m17284b.entrySet()) {
                if (m451r0.contains(entry.getValue())) {
