...
public final class FieldType {
    ...
    static {
        ...
        for (FieldType fieldType52 : values) {
            VALUES[fieldType52.f11356id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = C41071.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        boolean z = true;
        if (i4 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i3 = C41071.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : z;
    }
