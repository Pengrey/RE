...
public final class Ed25519 {
    ...
    public static class CachedXYZT extends CachedXYT {
        ...
        public void multByZ(long[] jArr, long[] jArr2) {
            Field25519.mult(jArr, jArr2, this.f11361z);
        }
        ...
        CachedXYZT(XYZT xyzt) {
            ...
            XYZ xyz = xyzt.xyz;
            Field25519.sum(jArr, xyz.f11364y, xyz.f11363x);
            long[] jArr2 = this.yMinusX;
            XYZ xyz2 = xyzt.xyz;
            Field25519.sub(jArr2, xyz2.f11364y, xyz2.f11363x);
            System.arraycopy(xyzt.xyz.f11365z, 0, this.f11361z, 0, 10);
            Field25519.mult(this.t2d, xyzt.f11366t, Ed25519Constants.f11369D2);
        }
    ...
    public static class PartialXYZT {
        ...
        PartialXYZT(PartialXYZT partialXYZT) {
            ...
            this.f11362t = Arrays.copyOf(partialXYZT.f11362t, 10);
        }
    }
    ...
    public static class XYZ {
        ...
        static XYZ fromPartialXYZT(XYZ xyz, PartialXYZT partialXYZT) {
            Field25519.mult(xyz.f11363x, partialXYZT.xyz.f11363x, partialXYZT.f11362t);
            long[] jArr = xyz.f11364y;
            XYZ xyz2 = partialXYZT.xyz;
            Field25519.mult(jArr, xyz2.f11364y, xyz2.f11365z);
            Field25519.mult(xyz.f11365z, partialXYZT.xyz.f11365z, partialXYZT.f11362t);
            return xyz;
        }

        boolean isOnCurve() {
            long[] jArr = new long[10];
            Field25519.square(jArr, this.f11363x);
            long[] jArr2 = new long[10];
            Field25519.square(jArr2, this.f11364y);
            long[] jArr3 = new long[10];
            Field25519.square(jArr3, this.f11365z);
            ...
            Field25519.mult(jArr6, jArr6, Ed25519Constants.f11368D);
        ...
        byte[] toBytes() {
            ...
            long[] jArr2 = new long[10];
            long[] jArr3 = new long[10];
            Field25519.inverse(jArr, this.f11365z);
            Field25519.mult(jArr2, this.f11363x, jArr);
            Field25519.mult(jArr3, this.f11364y, jArr);
        ...
        XYZ(XYZ xyz) {
            this.f11363x = Arrays.copyOf(xyz.f11363x, 10);
            this.f11364y = Arrays.copyOf(xyz.f11364y, 10);
            this.f11365z = Arrays.copyOf(xyz.f11365z, 10);
        }
    ...
    public static class XYZT {
        ...
        public static XYZT fromBytesNegateVarTime(byte[] bArr) throws GeneralSecurityException {
            ...
            Field25519.mult(jArr5, jArr4, Ed25519Constants.f11368D);
        ...
        public static XYZT fromPartialXYZT(XYZT xyzt, PartialXYZT partialXYZT) {
            Field25519.mult(xyzt.xyz.f11363x, partialXYZT.xyz.f11363x, partialXYZT.f11362t);
            long[] jArr = xyzt.xyz.f11364y;
            XYZ xyz = partialXYZT.xyz;
            Field25519.mult(jArr, xyz.f11364y, xyz.f11365z);
            Field25519.mult(xyzt.xyz.f11365z, partialXYZT.xyz.f11365z, partialXYZT.f11362t);
            long[] jArr2 = xyzt.f11366t;
            XYZ xyz2 = partialXYZT.xyz;
            Field25519.mult(jArr2, xyz2.f11363x, xyz2.f11364y);
            return xyzt;
        }
    ...
    private static void add(PartialXYZT partialXYZT, XYZT xyzt, CachedXYT cachedXYT) {
        long[] jArr = new long[10];
        long[] jArr2 = partialXYZT.xyz.f11363x;
        XYZ xyz = xyzt.xyz;
        Field25519.sum(jArr2, xyz.f11364y, xyz.f11363x);
        long[] jArr3 = partialXYZT.xyz.f11364y;
        XYZ xyz2 = xyzt.xyz;
        Field25519.sub(jArr3, xyz2.f11364y, xyz2.f11363x);
        long[] jArr4 = partialXYZT.xyz.f11364y;
        Field25519.mult(jArr4, jArr4, cachedXYT.yMinusX);
        XYZ xyz3 = partialXYZT.xyz;
        Field25519.mult(xyz3.f11365z, xyz3.f11363x, cachedXYT.yPlusX);
        Field25519.mult(partialXYZT.f11362t, xyzt.f11366t, cachedXYT.t2d);
        cachedXYT.multByZ(partialXYZT.xyz.f11363x, xyzt.xyz.f11365z);
        long[] jArr5 = partialXYZT.xyz.f11363x;
        Field25519.sum(jArr, jArr5, jArr5);
        XYZ xyz4 = partialXYZT.xyz;
        Field25519.sub(xyz4.f11363x, xyz4.f11365z, xyz4.f11364y);
        XYZ xyz5 = partialXYZT.xyz;
        long[] jArr6 = xyz5.f11364y;
        Field25519.sum(jArr6, xyz5.f11365z, jArr6);
        Field25519.sum(partialXYZT.xyz.f11365z, jArr, partialXYZT.f11362t);
        long[] jArr7 = partialXYZT.f11362t;
    ...
    private static XYZ doubleScalarMultVarTime(byte[] bArr, XYZT xyzt, byte[] bArr2) {
        ...
        while (i2 >= 0) {
            ...
            if (slide2[i2] > 0) {
                add(partialXYZT2, XYZT.fromPartialXYZT(xyzt3, partialXYZT2), Ed25519Constants.f11367B2[slide2[i2] / 2]);
            } else if (slide2[i2] < 0) {
                sub(partialXYZT2, XYZT.fromPartialXYZT(xyzt3, partialXYZT2), Ed25519Constants.f11367B2[(-slide2[i2]) / 2]);
            }
            i2--;
        }
    ...
    private static void doubleXYZ(PartialXYZT partialXYZT, XYZ xyz) {
        long[] jArr = new long[10];
        Field25519.square(partialXYZT.xyz.f11363x, xyz.f11363x);
        Field25519.square(partialXYZT.xyz.f11365z, xyz.f11364y);
        Field25519.square(partialXYZT.f11362t, xyz.f11365z);
        long[] jArr2 = partialXYZT.f11362t;
        Field25519.sum(jArr2, jArr2, jArr2);
        Field25519.sum(partialXYZT.xyz.f11364y, xyz.f11363x, xyz.f11364y);
        Field25519.square(jArr, partialXYZT.xyz.f11364y);
        XYZ xyz2 = partialXYZT.xyz;
        Field25519.sum(xyz2.f11364y, xyz2.f11365z, xyz2.f11363x);
        XYZ xyz3 = partialXYZT.xyz;
        long[] jArr3 = xyz3.f11365z;
        Field25519.sub(jArr3, jArr3, xyz3.f11363x);
        XYZ xyz4 = partialXYZT.xyz;
        Field25519.sub(xyz4.f11363x, jArr, xyz4.f11364y);
        long[] jArr4 = partialXYZT.f11362t;
        Field25519.sub(jArr4, jArr4, partialXYZT.xyz.f11365z);
    }
    ...
    /* renamed from: eq */
    private static int m28487eq(int i, int i2) {
        int i3 = (~(i ^ i2)) & 255;
        int i4 = i3 & (i3 << 4);
        int i5 = i4 & (i4 << 2);
        return ((i5 & (i5 << 1)) >> 7) & 1;
    ...
    private static void select(CachedXYT cachedXYT, int i, byte b) {
        ...
        cachedXYT.copyConditional(cachedXYTArr[i][0], m28487eq(i3, 1));
        cachedXYT.copyConditional(cachedXYTArr[i][1], m28487eq(i3, 2));
        cachedXYT.copyConditional(cachedXYTArr[i][2], m28487eq(i3, 3));
        cachedXYT.copyConditional(cachedXYTArr[i][3], m28487eq(i3, 4));
        cachedXYT.copyConditional(cachedXYTArr[i][4], m28487eq(i3, 5));
        cachedXYT.copyConditional(cachedXYTArr[i][5], m28487eq(i3, 6));
        cachedXYT.copyConditional(cachedXYTArr[i][6], m28487eq(i3, 7));
        cachedXYT.copyConditional(cachedXYTArr[i][7], m28487eq(i3, 8));
    ...
    private static void sub(PartialXYZT partialXYZT, XYZT xyzt, CachedXYT cachedXYT) {
        ...
        XYZ xyz3 = partialXYZT.xyz;
        Field25519.mult(xyz3.f11365z, xyz3.f11363x, cachedXYT.yMinusX);
        Field25519.mult(partialXYZT.f11362t, xyzt.f11366t, cachedXYT.t2d);
        cachedXYT.multByZ(partialXYZT.xyz.f11363x, xyzt.xyz.f11365z);
        long[] jArr5 = partialXYZT.xyz.f11363x;
        Field25519.sum(jArr, jArr5, jArr5);
        ...
        long[] jArr6 = xyz5.f11364y;
        Field25519.sum(jArr6, xyz5.f11365z, jArr6);
        Field25519.sub(partialXYZT.xyz.f11365z, jArr, partialXYZT.f11362t);
        long[] jArr7 = partialXYZT.f11362t;
