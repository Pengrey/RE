...
public final class EllipticCurves {
    ...
    public static /* synthetic */ class C41591 {
        ...
        static final /* synthetic */ int[] f11372x7c2ee98b;

        /* renamed from: $SwitchMap$com$google$crypto$tink$subtle$EllipticCurves$PointFormatType */
        static final /* synthetic */ int[] f11373xc12280c3;

        static {
            int[] iArr = new int[CurveType.values().length];
            f11372x7c2ee98b = iArr;
            try {
                iArr[CurveType.NIST_P256.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f11372x7c2ee98b[CurveType.NIST_P384.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f11372x7c2ee98b[CurveType.NIST_P521.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            int[] iArr2 = new int[PointFormatType.values().length];
            f11373xc12280c3 = iArr2;
            try {
                iArr2[PointFormatType.UNCOMPRESSED.ordinal()] = 1;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f11373xc12280c3[PointFormatType.DO_NOT_USE_CRUNCHY_UNCOMPRESSED.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f11373xc12280c3[PointFormatType.COMPRESSED.ordinal()] = 3;
    ...
    public static int encodingSizeInBytes(EllipticCurve ellipticCurve, PointFormatType pointFormatType) throws GeneralSecurityException {
        ...
        int i = C41591.f11373xc12280c3[pointFormatType.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
    ...
    public static ECParameterSpec getCurveSpec(CurveType curveType) throws NoSuchAlgorithmException {
        int i = C41591.f11372x7c2ee98b[curveType.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
