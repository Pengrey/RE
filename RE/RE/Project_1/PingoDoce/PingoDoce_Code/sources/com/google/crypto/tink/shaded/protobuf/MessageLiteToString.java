...
public final class MessageLiteToString {
    ...
    private static boolean isDefaultValue(Object obj) {
        ...
        if (obj instanceof Integer) {
            ...
            return obj.equals(BuildConfig.VERSION_NAME);
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static final void printField(StringBuilder sb2, int i, String str, Object obj) {
        if (obj instanceof List) {
            for (Object obj2 : (List) obj) {
                printField(sb2, i, str, obj2);
            }
        } else if (obj instanceof Map) {
            for (Map.Entry entry : ((Map) obj).entrySet()) {
                printField(sb2, i, str, entry);
            }
        } else {
            sb2.append('\n');
            int i2 = 0;
            ...
            if (obj instanceof String) {
                ...
                int i4 = i + 2;
                printField(sb2, i4, "key", entry2.getKey());
                printField(sb2, i4, "value", entry2.getValue());
                sb2.append("\n");
                while (i2 < i) {
                    sb2.append(' ');
                    i2++;
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb2, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (substring.endsWith(LIST_SUFFIX) && !substring.endsWith(BUILDER_LIST_SUFFIX) && !substring.equals(LIST_SUFFIX)) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    printField(sb2, i, camelCaseToSnakeCase(str2), GeneratedMessageLite.invokeOrDie(method2, messageLite, new Object[0]));
                }
            }
            if (substring.endsWith(MAP_SUFFIX) && !substring.equals(MAP_SUFFIX)) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    printField(sb2, i, camelCaseToSnakeCase(str3), GeneratedMessageLite.invokeOrDie(method3, messageLite, new Object[0]));
                }
            }
            if (((Method) hashMap2.get("set" + substring)) != null) {
                ...
                if (method4 != null) {
                    ...
                    if (z) {
                        printField(sb2, i, camelCaseToSnakeCase(str4), invokeOrDie);
                    }
                }
            }
        }
        if (messageLite instanceof GeneratedMessageLite.ExtendableMessage) {
            ...
            while (it.hasNext()) {
                printField(sb2, i, "[" + next.getKey().getNumber() + "]", it.next().getValue());
            }
        }
        UnknownFieldSetLite unknownFieldSetLite = ((GeneratedMessageLite) messageLite).unknownFields;
        if (unknownFieldSetLite != null) {
            unknownFieldSetLite.printWithIndent(sb2, i);
        }
    }
