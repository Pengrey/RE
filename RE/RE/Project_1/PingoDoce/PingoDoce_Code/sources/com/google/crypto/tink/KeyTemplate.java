...
public final class KeyTemplate {
    ...
    /* renamed from: kt */
    private final com.google.crypto.tink.proto.KeyTemplate f11277kt;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.google.crypto.tink.KeyTemplate$1 */
    /* loaded from: classes.dex */
    public static /* synthetic */ class C39791 {
    ...
    private static OutputPrefixType fromProto(com.google.crypto.tink.proto.OutputPrefixType outputPrefixType) {
        int i = C39791.$SwitchMap$com$google$crypto$tink$proto$OutputPrefixType[outputPrefixType.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i == 4) {
    ...
    private static com.google.crypto.tink.proto.OutputPrefixType toProto(OutputPrefixType outputPrefixType) {
        int i = C39791.$SwitchMap$com$google$crypto$tink$KeyTemplate$OutputPrefixType[outputPrefixType.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i == 4) {
    ...
    public OutputPrefixType getOutputPrefixType() {
        return fromProto(this.f11277kt.getOutputPrefixType());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public com.google.crypto.tink.proto.KeyTemplate getProto() {
        return this.f11277kt;
    }

    public String getTypeUrl() {
        return this.f11277kt.getTypeUrl();
    }

    public byte[] getValue() {
        return this.f11277kt.getValue().toByteArray();
    }
}
