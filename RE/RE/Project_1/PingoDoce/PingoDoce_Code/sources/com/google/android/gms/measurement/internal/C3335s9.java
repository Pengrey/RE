...
public final class C3335s9 extends AbstractC3323r8 {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public C3335s9(C3137a9 c3137a9) {
        super(c3137a9);
    }

    /* renamed from: n */
    private final C3280n9 m31013n(Integer num) {
        if (this.f8877f.containsKey(num)) {
            return (C3280n9) this.f8877f.get(num);
        }
        C3280n9 c3280n9 = new C3280n9(this, this.f8875d, null);
        this.f8877f.put(num, c3280n9);
        return c3280n9;
    }

    /* renamed from: o */
    private final boolean m31012o(int i, int i2) {
        C3280n9 c3280n9 = (C3280n9) this.f8877f.get(Integer.valueOf(i));
        if (c3280n9 == null) {
            return false;
        }
        return C3280n9.m31060b(c3280n9).get(i2);
    }
    ...
    */
    public final java.util.List m31014m(java.lang.String r66, java.util.List r67, java.util.List r68, java.lang.Long r69, java.lang.Long r70) {
        /*
            Method dump skipped, instructions count: 2815
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C3335s9.m31014m(java.lang.String, java.util.List, java.util.List, java.lang.Long, java.lang.Long):java.util.List");
    }
}
