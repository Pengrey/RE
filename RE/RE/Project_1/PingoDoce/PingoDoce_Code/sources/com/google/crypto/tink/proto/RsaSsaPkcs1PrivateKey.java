...
public final class RsaSsaPkcs1PrivateKey extends GeneratedMessageLite<RsaSsaPkcs1PrivateKey, Builder> implements RsaSsaPkcs1PrivateKeyOrBuilder {
    ...
    /* renamed from: d_ */
    private ByteString f11338d_;
    private ByteString dp_;
    private ByteString dq_;

    /* renamed from: p_ */
    private ByteString f11339p_;
    private RsaSsaPkcs1PublicKey publicKey_;

    /* renamed from: q_ */
    private ByteString f11340q_;
    private int version_;

    /* renamed from: com.google.crypto.tink.proto.RsaSsaPkcs1PrivateKey$1 */
    /* loaded from: classes.dex */
    static /* synthetic */ class C40841 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f11341xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f11341xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f11341xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f11341xa1df5c61[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f11341xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f11341xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f11341xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f11341xa1df5c61[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<RsaSsaPkcs1PrivateKey, Builder> implements RsaSsaPkcs1PrivateKeyOrBuilder {
        /* synthetic */ Builder(C40841 c40841) {
            this();
        }
    ...
    private RsaSsaPkcs1PrivateKey() {
        ...
        this.f11338d_ = byteString;
        this.f11339p_ = byteString;
        this.f11340q_ = byteString;
        this.dp_ = byteString;
        this.dq_ = byteString;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void clearD() {
        this.f11338d_ = getDefaultInstance().getD();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void clearP() {
        this.f11339p_ = getDefaultInstance().getP();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void clearQ() {
        this.f11340q_ = getDefaultInstance().getQ();
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C40841.f11341xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
