...
public final class Period extends BasePeriod {
    ...
    public Seconds toStandardSeconds() {
        ...
        return Seconds.seconds(FieldUtils.safeToInt(FieldUtils.safeAdd(FieldUtils.safeAdd(FieldUtils.safeAdd(FieldUtils.safeAdd(FieldUtils.safeAdd(getMillis() / DateTimeConstants.MILLIS_PER_SECOND, getSeconds()), getMinutes() * 60), getHours() * 3600), getDays() * 86400), getWeeks() * 604800)));
    }
