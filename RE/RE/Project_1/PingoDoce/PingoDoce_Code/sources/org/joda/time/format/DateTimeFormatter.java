...
public class DateTimeFormatter {
    ...
    public DateTimeFormatter(DateTimePrinter dateTimePrinter, DateTimeParser dateTimeParser) {
        this(DateTimePrinterInternalPrinter.m16412of(dateTimePrinter), DateTimeParserInternalParser.m16413of(dateTimeParser));
    }
    ...
    public DateTimeParser getParser() {
        return InternalParserDateTimeParser.m16411of(this.iParser);
    }
    ...
    public DateTimePrinter getPrinter() {
        return InternalPrinterDateTimePrinter.m16410of(this.iPrinter);
    }
