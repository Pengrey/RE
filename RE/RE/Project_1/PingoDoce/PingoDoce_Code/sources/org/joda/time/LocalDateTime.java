...
public final class LocalDateTime extends BaseLocal implements Serializable {
    ...
    public static LocalDateTime fromDateFields(Date date) {
        if (date != null) {
            ...
            return new LocalDateTime(date.getYear() + 1900, date.getMonth() + 1, date.getDate(), date.getHours(), date.getMinutes(), date.getSeconds(), (((int) (date.getTime() % 1000)) + DateTimeConstants.MILLIS_PER_SECOND) % DateTimeConstants.MILLIS_PER_SECOND);
        }
