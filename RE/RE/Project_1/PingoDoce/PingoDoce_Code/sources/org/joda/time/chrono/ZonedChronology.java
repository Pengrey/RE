...
public final class ZonedChronology extends AssembledChronology {
    ...
    public static final class ZonedDateTimeField extends BaseDateTimeField {
        ...
        public int getDifference(long j, long j2) {
            ...
            return this.iField.getDifference(j + (this.iTimeField ? offsetToAdd : getOffsetToAdd(j)), j2 + offsetToAdd);
        }

        @Override // org.joda.time.field.BaseDateTimeField, org.joda.time.DateTimeField
        public long getDifferenceAsLong(long j, long j2) {
            int offsetToAdd = getOffsetToAdd(j2);
            return this.iField.getDifferenceAsLong(j + (this.iTimeField ? offsetToAdd : getOffsetToAdd(j)), j2 + offsetToAdd);
        }
