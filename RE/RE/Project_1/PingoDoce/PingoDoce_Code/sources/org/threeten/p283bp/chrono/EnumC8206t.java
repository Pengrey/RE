...
/* renamed from: org.threeten.bp.chrono.t */
/* loaded from: classes2.dex */
public enum EnumC8206t implements InterfaceC8190i {
    BEFORE_ROC,
    ROC;

    /* renamed from: of */
    public static EnumC8206t m16239of(int i) {
        if (i != 0) {
            if (i == 1) {
                return ROC;
            }
    ...
    public static EnumC8206t readExternal(DataInput dataInput) throws IOException {
        return m16239of(dataInput.readByte());
    }

    private Object writeReplace() {
        return new C8207u((byte) 6, this);
    }
