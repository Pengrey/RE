...
/* renamed from: org.threeten.bp.chrono.x */
/* loaded from: classes2.dex */
public enum EnumC8212x implements InterfaceC8190i {
    BEFORE_BE,
    BE;

    /* renamed from: of */
    public static EnumC8212x m16207of(int i) {
        if (i != 0) {
            if (i == 1) {
                return BE;
            }
    ...
    public static EnumC8212x readExternal(DataInput dataInput) throws IOException {
        return m16207of(dataInput.readByte());
    }

    private Object writeReplace() {
        return new C8207u((byte) 8, this);
    }
