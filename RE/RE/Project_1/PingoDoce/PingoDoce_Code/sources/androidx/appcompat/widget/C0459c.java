...
public class C0459c extends AutoCompleteTextView implements InterfaceC1217z {

    /* renamed from: y */
    private static final int[] f1529y = {16843126};

    /* renamed from: w */
    private final C0463d f1530w;

    /* renamed from: x */
    private final C0531w f1531x;

    public C0459c(Context context, AttributeSet attributeSet) {
    ...
    protected void drawableStateChanged() {
        ...
        C0463d c0463d = this.f1530w;
        if (c0463d != null) {
            c0463d.m40660b();
        }
        C0531w c0531w = this.f1531x;
        if (c0531w != null) {
            c0531w.m40396b();
        }
    }
    ...
    public C0459c(Context context, AttributeSet attributeSet, int i) {
        super(C0512p0.m40482b(context), attributeSet, i);
        C0508n0.m40495a(this, getContext());
        C0520s0 m40453v = C0520s0.m40453v(getContext(), attributeSet, f1529y, i, 0);
