...
public class C1698d {
    ...
    */
    private static android.view.animation.Interpolator m35684a(android.content.Context r2, android.content.res.Resources r3, android.content.res.Resources.Theme r4, org.xmlpull.v1.XmlPullParser r5) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            int r3 = r5.getDepth()
            r4 = 0
        L5:
        ...
        Lca:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.C1698d.m35684a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator");
    }

    /* renamed from: b */
    public static Interpolator m35683b(Context context, int i) throws Resources.NotFoundException {
        ...
        try {
            try {
                ...
                Interpolator m35684a = m35684a(context, context.getResources(), context.getTheme(), animation);
                if (animation != null) {
                    animation.close();
                }
                return m35684a;
