...
public final class DefaultCallAdapterFactory extends CallAdapter.Factory {
    ...
    public static final class ExecutorCallbackCall<T> implements Call<T> {
        ...
        /* loaded from: classes2.dex */
        public class C98841 implements Callback<T> {
            final /* synthetic */ Callback val$callback;

            C98841(Callback callback) {
            ...
            public void onFailure(Call<T> call, final Throwable th2) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.a
                    ...
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.C98841.this.lambda$onFailure$1(callback, th2);
                    }
                });
            }
            ...
            public void onResponse(Call<T> call, final Response<T> response) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.b
                    @Override // java.lang.Runnable
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.C98841.this.lambda$onResponse$0(callback, response);
                    }
                });
            }
        }
        ...
        public void enqueue(Callback<T> callback) {
            ...
            this.delegate.enqueue(new C98841(callback));
        }
        ...
        @Override // retrofit2.Call
        public Call<T> clone() {
            return new ExecutorCallbackCall(this.callbackExecutor, this.delegate.mo39647clone());
        }
    }
