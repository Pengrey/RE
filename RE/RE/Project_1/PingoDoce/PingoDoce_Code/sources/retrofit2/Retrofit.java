...
public final class Retrofit {
    ...
    final InterfaceC5469e.InterfaceC5470a callFactory;
    @Nullable
    ...
    Retrofit(InterfaceC5469e.InterfaceC5470a interfaceC5470a, HttpUrl httpUrl, List<Converter.Factory> list, List<CallAdapter.Factory> list2, @Nullable Executor executor, boolean z) {
    ...
    public InterfaceC5469e.InterfaceC5470a callFactory() {
    ...
    public static final class Builder {
        ...
        @Nullable
        private InterfaceC5469e.InterfaceC5470a callFactory;
        @Nullable
        ...
        public Builder baseUrl(URL url) {
            ...
            return baseUrl(HttpUrl.m23984h(url.toString()));
        }

        public Retrofit build() {
            if (this.baseUrl != null) {
                InterfaceC5469e.InterfaceC5470a interfaceC5470a = this.callFactory;
                if (interfaceC5470a == null) {
                    interfaceC5470a = new OkHttpClient();
                }
                InterfaceC5469e.InterfaceC5470a interfaceC5470a2 = interfaceC5470a;
                ...
                return new Retrofit(interfaceC5470a2, this.baseUrl, Collections.unmodifiableList(arrayList2), Collections.unmodifiableList(arrayList), executor2, this.validateEagerly);
            }
        ...
        public Builder callFactory(InterfaceC5469e.InterfaceC5470a interfaceC5470a) {
            Objects.requireNonNull(interfaceC5470a, "factory == null");
            this.callFactory = interfaceC5470a;
            return this;
        }
        ...
        public Builder baseUrl(String str) {
            ...
            return baseUrl(HttpUrl.m23984h(str));
        }
        ...
        public Builder baseUrl(HttpUrl httpUrl) {
            ...
            List<String> m23979m = httpUrl.m23979m();
            if (BuildConfig.VERSION_NAME.equals(m23979m.get(m23979m.size() - 1))) {
                this.baseUrl = httpUrl;
                return this;
            }
