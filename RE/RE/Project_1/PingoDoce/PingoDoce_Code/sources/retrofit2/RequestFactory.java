...
public final class RequestFactory {
    ...
    public static final class Builder {
        ...
        private ParameterHandler<?> parseParameter(int i, Type type, @Nullable Annotation[] annotationArr, boolean z) {
            ...
            if (parameterHandler == null) {
                if (z) {
                    try {
                        if (Utils.getRawType(type) == InterfaceC1886d.class) {
                ...
                if (this.isMultipart) {
                    ...
                    if (value5.isEmpty()) {
                        if (Iterable.class.isAssignableFrom(rawType8)) {
                            if (type instanceof ParameterizedType) {
                                if (MultipartBody.C5508c.class.isAssignableFrom(Utils.getRawType(Utils.getParameterUpperBound(0, (ParameterizedType) type)))) {
                            ...
                            if (MultipartBody.C5508c.class.isAssignableFrom(rawType8.getComponentType())) {
                                return ParameterHandler.RawPart.INSTANCE.array();
                            }
                            throw Utils.parameterError(this.method, i, "@Part annotation must supply a name or use MultipartBody.Part parameter type.", new Object[0]);
                        } else if (MultipartBody.C5508c.class.isAssignableFrom(rawType8)) {
                            return ParameterHandler.RawPart.INSTANCE;
                        } else {
                            throw Utils.parameterError(this.method, i, "@Part annotation must supply a name or use MultipartBody.Part parameter type.", new Object[0]);
                        }
                    }
                    Headers m24010o = Headers.m24010o("Content-Disposition", "form-data; name=\"" + value5 + "\"", "Content-Transfer-Encoding", part.encoding());
                    if (Iterable.class.isAssignableFrom(rawType8)) {
                        if (type instanceof ParameterizedType) {
                            Type parameterUpperBound4 = Utils.getParameterUpperBound(0, (ParameterizedType) type);
                            if (!MultipartBody.C5508c.class.isAssignableFrom(Utils.getRawType(parameterUpperBound4))) {
                                return new ParameterHandler.Part(this.method, i, m24010o, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                            }
                        ...
                        if (!MultipartBody.C5508c.class.isAssignableFrom(boxIfPrimitive)) {
                            return new ParameterHandler.Part(this.method, i, m24010o, this.retrofit.requestBodyConverter(boxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                        }
                        throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                    } else if (!MultipartBody.C5508c.class.isAssignableFrom(rawType8)) {
                        return new ParameterHandler.Part(this.method, i, m24010o, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                    } else {
                        throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                    }
                }
                    ...
                    if (Map.class.isAssignableFrom(rawType9)) {
                        ...
                        if (supertype4 instanceof ParameterizedType) {
                            ...
                            if (String.class == parameterUpperBound5) {
                                ...
                                if (!MultipartBody.C5508c.class.isAssignableFrom(Utils.getRawType(parameterUpperBound6))) {
    ...
    public Request create(Object[] objArr) throws IOException {
        ...
        if (length == parameterHandlerArr.length) {
            ...
            return requestBuilder.get().m24251o(Invocation.class, new Invocation(this.method, arrayList)).m24264b();
        }
