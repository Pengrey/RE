...
public abstract class ParameterHandler<T> {
    ...
    static final class Body<T> extends ParameterHandler<T> {
        ...
        void apply(RequestBuilder requestBuilder, @Nullable T t) {
            ...
            throw Utils.parameterError(this.method, this.f25872p, "Body parameter value must not be null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f25873p, "Field map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f25873p, "Field map was null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f25874p, "Header map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f25874p, "Header map was null.", new Object[0]);
        }
    }

    /* loaded from: classes2.dex */
    static final class Headers extends ParameterHandler<p107ff.Headers> {
        private final Method method;

        /* renamed from: p */
        private final int f25875p;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // retrofit2.ParameterHandler
        public void apply(RequestBuilder requestBuilder, @Nullable p107ff.Headers headers) {
            if (headers != null) {
                requestBuilder.addHeaders(headers);
                return;
            }
            throw Utils.parameterError(this.method, this.f25875p, "Headers parameter must not be null.", new Object[0]);
        }
    }
    ...
    static final class Part<T> extends ParameterHandler<T> {
        private final Converter<T, RequestBody> converter;
        private final p107ff.Headers headers;
        private final Method method;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public Part(Method method, int i, p107ff.Headers headers, Converter<T, RequestBody> converter) {
            this.method = method;
            this.f25876p = i;
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        T value = entry.getValue();
                        if (value != null) {
                            requestBuilder.addPart(p107ff.Headers.m24010o("Content-Disposition", "form-data; name=\"" + key + "\"", "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
                        } else {
                            Method method = this.method;
                            int i = this.f25877p;
                        ...
                        throw Utils.parameterError(this.method, this.f25877p, "Part map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f25877p, "Part map was null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f25879p, "Query map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f25879p, "Query map was null", new Object[0]);
        }
    }
    ...
    /* loaded from: classes2.dex */
    static final class RawPart extends ParameterHandler<MultipartBody.C5508c> {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // retrofit2.ParameterHandler
        public void apply(RequestBuilder requestBuilder, @Nullable MultipartBody.C5508c c5508c) {
            if (c5508c != null) {
                requestBuilder.addPart(c5508c);
            }
        }
    }
    ...
    static final class RelativeUrl extends ParameterHandler<Object> {
        ...
        void apply(RequestBuilder requestBuilder, @Nullable Object obj) {
            ...
            throw Utils.parameterError(this.method, this.f25880p, "@Url parameter is null.", new Object[0]);
        }
    }
