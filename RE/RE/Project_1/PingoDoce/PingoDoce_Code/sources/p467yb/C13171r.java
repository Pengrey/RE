...
final class C13171r {
    ...
    /* renamed from: a */
    private static final Object f34126a;

    /* renamed from: b */
    private static final Object[][] f34127b;

    /* renamed from: c */
    private static final Object[][] f34128c;

    /* renamed from: d */
    private static final Object[][] f34129d;

    /* renamed from: e */
    private static final Object[][] f34130e;
    ...
    public static String m1491a(String str) throws NotFoundException {
        ...
        if (str.length() >= 2) {
            ...
            for (Object[] objArr5 : f34127b) {
                if (objArr5[0].equals(substring)) {
                    if (objArr5[1] == f34126a) {
                        return m1489c(2, ((Integer) objArr5[2]).intValue(), str);
                    }
                    return m1490b(2, ((Integer) objArr5[1]).intValue(), str);
                }
            }
            if (str.length() >= 3) {
                String substring2 = str.substring(0, 3);
                for (Object[] objArr6 : f34128c) {
                    if (objArr6[0].equals(substring2)) {
                        if (objArr6[1] == f34126a) {
                            return m1489c(3, ((Integer) objArr6[2]).intValue(), str);
                        }
                        return m1490b(3, ((Integer) objArr6[1]).intValue(), str);
                    }
                }
                for (Object[] objArr7 : f34129d) {
                    if (objArr7[0].equals(substring2)) {
                        if (objArr7[1] == f34126a) {
                            return m1489c(4, ((Integer) objArr7[2]).intValue(), str);
                        }
                        return m1490b(4, ((Integer) objArr7[1]).intValue(), str);
                    }
                }
                if (str.length() >= 4) {
                    String substring3 = str.substring(0, 4);
                    for (Object[] objArr8 : f34130e) {
                        if (objArr8[0].equals(substring3)) {
                            if (objArr8[1] == f34126a) {
                                return m1489c(4, ((Integer) objArr8[2]).intValue(), str);
                            }
                            return m1490b(4, ((Integer) objArr8[1]).intValue(), str);
                        }
                    }
    ...
    /* renamed from: b */
    private static String m1490b(int i, int i2, String str) throws NotFoundException {
        if (str.length() >= i) {
            ...
            if (str.length() >= i3) {
                ...
                String m1491a = m1491a(str.substring(i3));
                if (m1491a == null) {
                    return str2;
                }
                return str2 + m1491a;
    ...
    /* renamed from: c */
    private static String m1489c(int i, int i2, String str) throws NotFoundException {
        String substring = str.substring(0, i);
        int min = Math.min(str.length(), i2 + i);
        String substring2 = str.substring(i, min);
        String str2 = "(" + substring + ')' + substring2;
        String m1491a = m1491a(str.substring(min));
        if (m1491a == null) {
            return str2;
        }
        return str2 + m1491a;
